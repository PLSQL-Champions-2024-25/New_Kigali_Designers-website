...
import { Search, HelpCircle, ShoppingBag, Truck, RefreshCw, Palette, Phone, Mail, MessageCircle } from "lucide-react"
...
export default function HelpPage() {
  ...
  const quickActions = [
    ...
    {
      title: "Custom Design",
      description: "Start your custom design consultation",
      icon: Palette,
      action: "Start Design",
    },
    {
